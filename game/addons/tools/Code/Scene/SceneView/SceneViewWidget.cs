...
public partial class SceneViewWidget : Widget
{
	...
	/// <summary>
	/// hotkeys and funtion to nudge selected objects in all view modes (object, mapping, physics, ect)
	/// </summary>
	...
	{
		// Let SelectionTool handle its own nudge (vertex/face/edge modes)
